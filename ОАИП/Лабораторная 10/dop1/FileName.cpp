...
int count(Tree* t);  //Подсчет количества листьев правой дочерней ветви
...
int main()
{
	...
	for (;;)
	{
		...
		cout << "5 -	вывод дерева\n";
		cout << "6 -	подсчет количества листьев правой дочерней ветви\n";
		...
		case 6:  n = count(Root);
			n--;
			cout << "Количество листьев правой дочерней ветви " << n << endl;
...
int count(Tree* t) //Подсчет количества листьев правой дочерней вершины
{
	if (t)
	{
		count(t->Right);
